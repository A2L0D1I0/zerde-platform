...
export const ru = {
  ...
  'auth.submit_login': 'Вход',
  'auth.submit_register': 'Зарегистрироваться',
  'auth.switch_to_login': 'Уже есть аккаунт? Войти',
  'auth.switch_to_register': 'Зарегистрироваться ➔',
  'auth.processing': 'Выполняется...',
  'auth.role_switcher_student': 'Ученик',
  'auth.role_switcher_teacher': 'Преподаватель',
  'auth.student_subtitle': 'Вход в аккаунт ученика или регистрация нового профиля',
  'auth.teacher_subtitle': 'Вход для преподавателя или регистрация по токену школы',
  ...
  'auth.email_placeholder': 'name@school.kz',
  'auth.password_label': 'Пароль',
  'auth.password_placeholder': '••••••••',
  'auth.name_label': 'ФИО',
  'auth.name_placeholder': 'Введите ваше полное ФИО',
  'auth.name_placeholder_student': 'например: Саржанов Алдияр',
  'auth.name_placeholder_teacher': 'например: Алибек Нурланулы',
  'auth.grade_label': 'Класс / Ступень обучения',
  'auth.grade_placeholder': 'Выберите класс или статус',
  'auth.city_label': 'Город / Регион',
  'auth.school_label': 'Школа / Организация',
  'auth.custom_school_placeholder': 'Введите название вашей школы или организации',
  'auth.school_not_found': 'Не нашли свою школу?',
  'auth.school_contact_support': 'обратитесь к администратору',
  'auth.bio_label': 'Интересы и учебный фокус (необязательно)',
  'auth.bio_placeholder': 'например: Подготовка к олимпиадам по математике и IT',
  'auth.subject_label': 'Основной предмет преподавания',
  'auth.subject_placeholder': 'например: Математика, Физика, Информатика',
  'auth.org_token_label': 'Токен аккредитации школы',
  'auth.org_token_placeholder': 'ORG-XXXXXX',
  'auth.org_token_hint': 'Официальный токен учебного заведения от завуча',
  ...
  'auth.name_required': 'Пожалуйста, введите ваше полное ФИО',
  'auth.student_role_desc': 'Войдите как ученик, чтобы развивать навыки и повышать ELO-рейтинг с наставником «Аға»',
  'auth.teacher_role_desc': 'Войдите как учитель, чтобы конструировать курсы и отслеживать тепловую матрицу класса',
  'auth.submitting': 'Выполняется вход...',
  'auth.login_success': 'Добро пожаловать в Zerde!',
  'auth.register_success': 'Аккаунт успешно создан! Добро пожаловать в Zerde.',
  'auth.logout_confirm': 'Вы уверены, что хотите выйти из системы?',
