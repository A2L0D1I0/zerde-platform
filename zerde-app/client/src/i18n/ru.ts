...
export const ru = {
  ...
  'teacher.tab_gradebook': 'Оценки & Аналитика',
  'teacher.tab_calendar': 'Календарь / Роадмап',
  'teacher.tab_ai_studio': 'AI Студия (5 Слотов)',
  'teacher.tab_copilot_chat': '💬 Чат с CoPilot',
  'teacher.select_classroom_label': 'Выбор класса (Группа):',
  'teacher.no_classrooms_option': 'Нет классов',
  'teacher.create_classroom_btn': 'Создать класс',
  'teacher.create_classroom_title': 'Создание учебного класса / группы',
  'teacher.create_classroom_desc': 'Введите название группы для зачисления учеников и ведения журнала.',
  'teacher.classroom_name_label': 'Название класса / группы',
  'teacher.classroom_name_placeholder': 'Например: 9 «А», 10 «Б» или Олимпиадники',
  'teacher.create_submit_btn': 'Создать',
  'teacher.cancel_btn': 'Отмена',
  'teacher.applications_btn': 'Модерация заявок',
  'teacher.students_count': '{count} уч.',
  'teacher.loading_data': 'Загрузка данных журнала...',
  'teacher.no_students_in_class': 'В классе пока нет зачисленных учеников ({classroom})',
  'teacher.no_classrooms_banner_title': 'У вас пока нет созданных классов',
  'teacher.no_classrooms_banner_desc': 'Создайте первый класс, чтобы модерировать заявки, зачислять учеников и отслеживать 2D-матрицу дефицитов.',
  'builder.tab_slots': '1. 5 Слотов Материалов',
  'builder.tab_plan': '2. Учебный План (КТП)',
  'builder.tab_generator': '3. Генератор Тестов KaTeX',
  'builder.tab_chat': '4. 💬 Чат с CoPilot',
  'builder.slot_badge_template': '📋 Демо-шаблон (ГОСО)',
  'builder.slot_badge_custom': '✏️ Пользовательский',
  'builder.slot_badge_empty': '📭 Пустой слот',
  'builder.slot_clear_btn': 'Очистить',
