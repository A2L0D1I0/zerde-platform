...
export const kz = {
  ...
  // ==========================================
  // 4. XP RANKS (XP дәрежелері мен лигалары)
  // ==========================================
  'rank.oskin': 'Өскін 🌱',
  'rank.oskin_desc': 'Бастапқы деңгей (800–1199 XP)',
  'rank.tughyr': 'Тұғыр 🌿',
  'rank.tughyr_desc': 'Негізгі деңгей (1200–1499 XP)',
  'rank.qyran': 'Қыран 🦅',
  'rank.qyran_desc': 'Озат деңгей (1500–1799 XP)',
  'rank.samgau': 'Самғау ⭐',
  'rank.samgau_desc': 'Шың деңгей (1800+ XP)',
  'rank.current_rank': 'Ағымдағы дәрежеңіз',
  'rank.next_rank_needed': 'Келесі дәрежеге дейін {points} XP қажет',
  ...
  'student.leaderboard_elo': 'XP ұпайы',
  ...
  'trainer.eureka_moment': '💡 Эврика сәті! (+15 XP)',
  'trainer.eureka_desc': 'Өздігіңізден терең заңдылықты түсініп, дұрыс логикалық шешім таптыңыз!',
  'trainer.academic_integrity_violation': '⚠️ Академиялық этиканы бұзу (-20 XP)',
  ...
  'teacher.tab_gradebook': 'Бағалау & Аналитика',
  'teacher.tab_calendar': 'Күнтізбе / Роадмап',
  'teacher.tab_ai_studio': 'AI Студия (5 Слот)',
  'teacher.tab_copilot_chat': '💬 AI CoPilot чаты',
  'teacher.select_classroom_label': 'Сыныпты таңдау (Группа):',
  'teacher.no_classrooms_option': 'Сыныптар жоқ',
  'teacher.create_classroom_btn': 'Жаңа сынып құру',
  'teacher.create_classroom_title': 'Жаңа оқу сыныбын / тобын құру',
  'teacher.create_classroom_desc': 'Оқушыларды қабылдау және журнал жүргізу үшін сынып атауын енгізіңіз.',
  'teacher.classroom_name_label': 'Сынып / Топ атауы',
  'teacher.classroom_name_placeholder': 'Мысалы: 9 «А», 10 «Б» немесе Олимпиадники',
  'teacher.create_submit_btn': 'Құру',
  'teacher.cancel_btn': 'Бас тарту',
  'teacher.applications_btn': 'Өтінімдерді басқару',
  'teacher.students_count': '{count} оқушы',
  'teacher.loading_data': 'Журнал мәліметтері жүктелуде...',
  'teacher.no_students_in_class': 'Сыныпта әлі тіркелген оқушылар жоқ ({classroom})',
  'teacher.no_classrooms_banner_title': 'Сізде әзірге сыныптар/топтар жоқ',
  'teacher.no_classrooms_banner_desc': 'Журналды ашу, оқушыларды заңды түрде қабылдау және дефициттерді көру үшін бірінші сыныбыңызды құрыңыз.',
  'builder.tab_slots': '1. 5 Оқу Материалы',
  'builder.tab_plan': '2. Оқу Жоспары (КТП)',
  'builder.tab_generator': '3. KaTeX Тест Генераторы',
  'builder.tab_chat': '4. 💬 CoPilot Чат',
  'builder.slot_badge_template': '📋 Демо-үлгі (ГОСО)',
  'builder.slot_badge_custom': '✏️ Мұғалім материалы',
  'builder.slot_badge_empty': '📭 Бос слот',
  'builder.slot_clear_btn': 'Тазалау',
