...
export const kz = {
  ...
  // ==========================================
  // 5. AUTH & REGISTRATION (Аутентификация және Тіркелу)
  // ==========================================
  'auth.sign_in': 'Кіру',
  'auth.sign_up': 'Тіркелу',
  'auth.submit_login': 'Кіру (Вход)',
  'auth.submit_register': 'Тіркелу (Регистрация)',
  'auth.switch_to_login': 'Бұрын тіркелгенсіз бе? Кіру',
  'auth.switch_to_register': 'Жаңа қолданушы тіркелу ➔',
  'auth.processing': 'Жүктелуде...',
  'auth.role_switcher_student': 'Оқушы',
  'auth.role_switcher_teacher': 'Мұғалім',
  'auth.student_subtitle': 'Оқушы кабинетіне кіру немесе жаңа аккаунт ашу',
  'auth.teacher_subtitle': 'Мұғалім кабинетіне кіру немесе мектеп токенімен тіркелу',
  ...
  'auth.name_label': 'Толық аты-жөніңіз',
  'auth.name_placeholder': 'Толық аты-жөніңізді енгізіңіз',
  'auth.name_placeholder_student': 'мысалы: Саржанов Алдияр',
  'auth.name_placeholder_teacher': 'мысалы: Алибек Нұрланұлы',
  'auth.grade_label': 'Сынып / Оқу деңгейі',
  'auth.grade_placeholder': 'Сыныбыңызды таңдаңыз',
  'auth.city_label': 'Қала / Аймақ',
  'auth.school_label': 'Мектеп / Ұйым',
  'auth.custom_school_placeholder': 'Мектеп немесе ұйым атауын жазыңыз',
  'auth.school_not_found': 'Мектебіңіз тізімде жоқ па?',
  'auth.school_contact_support': 'әкімшіге хабарласыңыз',
  'auth.bio_label': 'Оқу фокусы мен қызығушылықтарыңыз (міндетті емес)',
  'auth.bio_placeholder': 'мысалы: Олимпиадалық математика және бағдарламалау',
  'auth.subject_label': 'Негізгі сабақ беретін пәніңіз',
  'auth.subject_placeholder': 'мысалы: Алгебра, Физика, Информатика',
  'auth.org_token_label': 'Мектеп аккредитация токені',
  'auth.org_token_placeholder': 'ORG-XXXXXX',
  'auth.org_token_hint': 'Мектеп әкімшілігі берген ресми токен',
  ...
  'auth.has_account': 'Бұрын тіркелгенсіз бе? Кіру',
  'auth.name_required': 'Толық аты-жөніңізді енгізіңіз',
  ...
  'auth.login_success': 'Zerde экожүйесіне қош келдіңіз!',
  'auth.register_success': 'Аккаунт сәтті құрылды! Zerde-ге қош келдіңіз.',
  'auth.logout_confirm': 'Жүйеден шығуды растайсыз ба?',
